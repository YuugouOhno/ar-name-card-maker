                ...
                page == 0 && (
                    <div className="bg-[#B4FFF2]">
                        <div class="h-screen flex items-center justify-center lerative flex-col">
                            ...
                            <div className="flex">
                                <a onClick={() => { setPage(1) }} href="#" class="gradient1 mx-20">始める</a>
                                <a onClick={() => { setPage(2) }} class="gradient1 mx-20">使い方</a>
                            </div>
                        </div>
                    </div>
                )
                        ...
                        <div className="flex flex-col lg:flex-row py-12 justify-center mt-[80px]">
                            ...
                            <div className="flex-1 flex items-center justify-center w-1/2">
                                <div className="xl:flex">
                                    ...
                                    <div className="mr-3">
                                        <h2>デザイン</h2>
                                        <div className="flex">
                                            <img src="./d-1.png" className="w-[30%] m-2" onClick={() => setData("bg_image", "./d-1.png")} />
                                            <img src="./d-2.png" className="w-[30%] m-2" onClick={() => setData("bg_image", "./d-2.png")} />
                                            <img src="./d-3.png" className="w-[30%] m-2" onClick={() => setData("bg_image", "./d-3.png")} />
                                        </div>
                                        <div className="flex">
                                            <img src="./d-4.png" className="w-[30%] m-2" onClick={() => setData("bg_image", "./d-4.png")} />
                                            <img src="./d-5.png" className="w-[30%] m-2" onClick={() => setData("bg_image", "./d-5.png")} />
                                            <input type="color" className="w-[30%] h-auto m-2" onChange={(e) => setData("bg_color", e.target.value)} />
                                        </div>
                                    </div>
                            ...
                            <div className="flex lg:flex-col overflow-y-auto">
                                <div className="m-4 w-[455px] h-[275px] bg-white flex flex-col relative">
                                    <img src="./d-1.png" className="z-10 absolute w-[455px] h-[275px]" />
